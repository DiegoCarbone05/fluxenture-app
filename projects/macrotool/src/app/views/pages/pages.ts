import { afterNextRender, Component, computed, ViewChild } from '@angular/core';
...
export class Pages {
  ...
  constructor(
    ...
    // Novedades del ultimo deploy con anuncio: una sola vez por usuario/navegador (ver release-notes.ts).
    afterNextRender(() => whatsNew.showIfPending());
  }
